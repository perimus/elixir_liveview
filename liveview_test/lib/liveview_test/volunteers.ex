defmodule LiveviewTest.Volunteers do
  @moduledoc """
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(LiveviewTest.PubSub, "volunteers")
  end
  ...
  def list_volunteers do
    Repo.all(from volunteer in Volunteer, order_by: [desc: volunteer.id])
  end
  ...
  def broadcast({:ok, volunteer}, event) do
    Phoenix.PubSub.broadcast(LiveviewTest.PubSub, "volunteers", {event, volunteer})
    {:ok, volunteer}
  end
